...
<body class="impressum-page">
  <a class="skip" href="#main">Zum Inhalt springen</a>  <!-- Header -->
  ...
  <main id="main" class="container">
    ...
    <section>
      <h2>Kontakt</h2>
      <p>
        E-Mail: <a href="mailto:crazyfamilylp@gmail.com">crazyfamilylp@gmail.com</a>
      </p>
    </section>
    ...
    <section>
      <h2>Technische Umsetzung & Webdesign</h2>
      <p>
        <a href="https://nils-digital.de" target="_blank" rel="noopener noreferrer">
          nils-digital.de
        </a><br>
        (kein Verantwortlicher im Sinne des § 55 RStV)
      </p>
    </section>
